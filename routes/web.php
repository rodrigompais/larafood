...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::post('roles/{id}/permissions', 'ACL\PermissionRoleController@attachPermissionRole')->name('roles.permissions.attach');
         ...
         * Routes Tables
         */
        Route::any('tables/qrcode/{identify}', 'TableController@qrcode')->name('tables.qrcode');
        ...
        Route::get('categories/{id}/profile', 'CategoryProductController@products')->name('categories.products');
